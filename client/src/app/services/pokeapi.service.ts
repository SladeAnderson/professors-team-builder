...
import { LocalPkmn } from "./localPkmn.service";
...
export class Pokeapi {
    ...
    constructor(private http: HttpClient, private localPkmn: LocalPkmn) {}


    getDbPokeSummary$():Observable<halfPokemon[]> {
    ...
    getSummary$():Observable<pokemonSummery> {
    ...
    getLocalPkmnSummary$(summary:Link[]):Observable<halfPokemon[]> {
